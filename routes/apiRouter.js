...
// POST create post
router.post('/api/posts/', usercontroller.jwt_auth, postcontroller.create_post_post)

// GET a single blog post
router.get('/api/posts/:postId', postcontroller.one_post_get)

// DELETE to delete a post
router.delete('/api/posts/:postId', usercontroller.jwt_auth, postcontroller.one_post_delete) 

// PATCH to change one element on that post
router.patch('/api/posts/:postId', usercontroller.jwt_auth, postcontroller.one_post_patch) 
...
router.get('/api/users/:userId/posts', usercontroller.jwt_auth, postcontroller.user_posts_get)
